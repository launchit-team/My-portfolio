...
export default function Contact({ mode = 'video' }) {
  ...
  return <section id="contact" className="contact" aria-labelledby="contact-title"><div className="page-width">
    ...
    <div className="contact-content"><div className="contact-info"><span className="eyebrow">Direct contact</span><p>{content.direct}</p><a href="mailto:liveclipzs@gmail.com" className="contact-email">liveclipzs@gmail.com <Arrow /></a><div className="contact-promise"><span className="eyebrow">Good to include</span><p>{content.helpful}</p></div></div>
